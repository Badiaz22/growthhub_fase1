...
/// Barra de navegacion para la pantalla de inicio
///
/// Proporciona acceso a funciones primarias: agregar nota, buscar y cambiar
/// vista de grid. Incluye boton flotante flotante con efecto hero.
class HomeNavbarWidget extends StatelessWidget {
  /// Constructor de la navbar
            ...
            child: CustomRoundedButton(
              ...
              onPressed: () {
                DependencyProvider.of(
                  context,
                ).cardsBloc.updateColorSelection(1);
                Navigator.pushNamed(
                  context,
                  '/form',
