...
/// Business Logic Component (BLoC) para gestionar el estado de tarjetas
///
/// Centraliza toda la logica de negocios para operaciones con tarjetas:
/// crear, editar, eliminar y obtener. Utiliza el patron Stream para
/// notificar cambios de estado a los widgets.
class CardsBloc {
  /// Estado actual del Bloc
  CardsState _currentState;

  /// Controlador de stream que emitira la lista de tarjetas
  final StreamController<CardsState> _cardsController;

  /// Caso de uso para obtener tarjetas
  final GetCardsUseCase _getCardsUseCase;

  /// Constructor de CardsBloc
  ///
  /// Parametros:
  /// - [initialState]: Estado inicial (por defecto CardsState())
  /// - [getCardsUseCase]: Caso de uso para obtener tarjetas
  CardsBloc({
